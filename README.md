...
-Создан удаленный репозиторий для загрузки заданий.

-Изучен синтаксис разметки *Markdown*.

# **Пример кода на Python**

В ходе работы я написал программу, выполняющую простые математические действия и приветствующую пользователя
